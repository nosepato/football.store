    ...
    <div className="product-page-container">
      <div className="product-images">
        <Carousel>
          <div>
            <img
              src="/camisadocity1.jpg"
              alt="Camisa Torcedor Manchester City"
            />
          </div>
          <div>
            <img
              src="/camisadocity1costas.jpg"
      ...
      <div className="product-details">
        <h1 className="product-title">Camisa Torcedor Manchester City II 2023/24 Masculina</h1>
